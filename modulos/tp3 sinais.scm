...
(define segue-percurso-sinais
  (lambda (nave)
    (cond ((eq? (ve-frente nave) 14)  (frente nave 1)(roda-dir nave 1) (segue-percurso-sinais nave))
          ((eq? (ve-frente nave) 22)  (frente nave 1)(roda-esq nave 1) (segue-percurso-sinais nave))
          ((eq? (ve-frente nave) 13) (frente nave 1) (display "cheguei"))
          (else (frente nave 1) (segue-percurso-sinais nave)))))
